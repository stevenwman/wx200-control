...
def shutdown_sequence(robot_driver, velocity_limit=30):
    ...
    # Flush port before shutdown (control loop uses TxOnly, shutdown uses TxRx)
    ...
    # Create fresh port handler for shutdown sequence (ensures clean TxRx communication)

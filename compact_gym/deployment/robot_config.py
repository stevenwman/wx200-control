"""
Robot configuration for WX200 (Compact Gym Version).
...
class RobotConfig:
    ...
    # Gym Action Scaling (used for normalization)
    ...
    camera_id: int = 1 # Changed from 1 to 2 (maps to /dev/video2 for UC70 camera)
    ...
    move_delay: float = 1  # Seconds to wait between shutdown moves (increased to prevent slamming)
